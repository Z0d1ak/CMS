        ...
        public async Task<IActionResult> SaveByDataAsync()
        {
            ...
            if (formFile.Length > 0)
            {
                ...
                var resp = new ResponseDataDto
                {
                    ...
                    File = new ResponseFileDto
                    {
                        Url = "https://images11.esquire.ru/upload/img_cache/acf/acfbe9979332a4bab9cec3485f678f61_ce_1080x673x0x0_cropped_960x600.jpg"//"https://localhost:5001/Upload/" + fileName
                    }
                };
